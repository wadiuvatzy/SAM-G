...
class Workspace:
    ...
    def robo_record_gif(self):
        ...
        print("gif saved at %s/%s.gif" % (self.work_dir, self.agent_name))
        ...
        for i in tqdm(range(1, 101)):
            ...
            if self.level == 'train':
                ...
                if i < 100 and i % 10 == 0:
                    ...
                    self.eval_env = robo_make(name=self.cfg.task_name, action_repeat=self.cfg.action_repeat, frame_stack=self.cfg.frame_stack, seed=self.cfg.seed, scene_id=count, args=self.args)
