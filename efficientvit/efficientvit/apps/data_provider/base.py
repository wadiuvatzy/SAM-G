...
def parse_image_size(size: int or str) -> tuple:
...
class DataProvider:
    ...
    def __init__(
        ...
        n_worker: int,
        image_size: int or list or str or list,
    ...
    def build_valid_transform(self, image_size: tuple or None = None) -> any:
        raise NotImplementedError

    def build_train_transform(self, image_size: tuple or None = None) -> any:
        raise NotImplementedError
    ...
    def assign_active_image_size(self, new_size: int or tuple) -> None:
    ...
    def sample_val_dataset(self, train_dataset, valid_transform) -> tuple:
