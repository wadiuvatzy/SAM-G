...
class Workspace:
    def __init__(self, cfg):
        ...
        # masked_video_path = 'train.mp4'
        # fourcc = cv2.VideoWriter_fourcc(*'mp4v')
        # self.masked_video = cv2.VideoWriter(masked_video_path, fourcc, 10, (84, 84))
    ...
    def eval_adroit(self, force_number_episodes=None, do_log=True):
        ...
        for i in tqdm(range(n_eval_episode)):
            ...
            while not time_step.last():
                ...
                # self.masked_video.write(time_step.observation[6:9].transpose(1, 2, 0)[:, :, ::-1])
