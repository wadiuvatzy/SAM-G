...
from dmcvgb.wrappers import ColorWrapper, VideoWrapper, FrameStack, FrameStackWithSAM
...
def make_env(domain_name, task_name, seed, args):
    ...
    if args.use_SAM_g:
        env = FrameStackWithSAM(env, cfg_dict['frame_stack'], args=args)
    else:
